...
export default function ProfilePage({ authUsername, viewUsername = null }) {
  ...
  const Toggle = ({ value, onChange }) => (
    <button type="button" onClick={() => onChange(!value)}
      className={`relative inline-flex items-center h-6 rounded-full transition-colors shrink-0 ${value ? 'bg-sky-500' : 'bg-zinc-700'}`}
      style={{ width: '44px' }}>
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            ...
            <div className={`${card} p-6`}>
              ...
              <div className="flex items-center gap-3">
                <button onClick={saveProfile} disabled={saving} className="px-5 py-2 bg-sky-600 hover:bg-sky-500 text-white text-sm font-semibold rounded-lg transition disabled:opacity-50">
