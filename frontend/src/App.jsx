  ...
  const renderPortfolioView = () => {
    ...
    return (
      ...
      <button onClick={toggleHideValues} title={hideValues ? 'Show values' : 'Hide values'}
        className="fixed top-[calc(3rem+8px)] right-4 z-40 flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium border transition bg-zinc-900 border-zinc-700 text-zinc-400 hover:border-zinc-500 hover:text-zinc-300">
        {hideValues
